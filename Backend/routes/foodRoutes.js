...
const {addFood,getFood,updateFood, deleteFood,getFoodById,foodRating } = require("../controllers/addFoodController")
...
router.post("/foodratings",authenticate,foodRating)
router.get("/:id/menu",authenticate,getFoodById)
