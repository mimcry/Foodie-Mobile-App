...
const toast = useToast();
  ...
  const handleSubmit = async (event:any) => {
    ...
    try {
      const response = await fetch('http://192.168.1.70:8000/orderitems', {
        method: 'PUT',
        headers: {
      ...
      if (response.ok) {
        ...
        toast.show("Your order was placed!", {
          type: "success",
    ...
    <SafeAreaView style={styles.container}>
      {isCartEmpty ? (
        <View style={styles.emptyCartContainer}>
          ...
          <TouchableOpacity style={styles.startShoppingButton} onPress={()=>router.push("/(tabs)/menu")}>
