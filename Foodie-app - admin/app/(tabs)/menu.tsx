...
import { BadgeIndianRupee,Utensils,Tag,FileText,Hash, ImagePlus } from "lucide-react-native";
...
ToastAndroid.show("Please Select Food Image", ToastAndroid.SHORT);
    ...
    try {
      ...
      if (response.ok) {
        ...
        ToastAndroid.show(`${foodName} was  Added Successfully`, ToastAndroid.SHORT);
        setFoodName("");
        setPrice("");
        setDescription("");
        setOffer("");
    ...
    >
      ...
      >
        ...
        <TextInput
          ...
          placeholder="Enter Tags (e.g., Spicy, Vegan)"
          value={tags}
